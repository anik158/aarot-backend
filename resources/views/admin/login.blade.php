...
{{--                        </div>--}}
                ...
                <div>
                    <button type="submit"
                            class="flex w-full justify-center rounded-2xl hover:cursor-pointer bg-slate-900 px-4 py-4 text-sm font-black text-white shadow-xl shadow-slate-900/10 transition-all hover:bg-slate-800 hover:scale-[1.02] active:scale-[0.98] focus-visible:outline-none tracking-tight">
