    ...
    <div class="px-4 mx-auto max-w-7xl">
        ...
        <form action="{{ isset($attribute) ? route('admin.attributes.update', $attribute) : route('admin.attributes.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 gap-8 md:grid-cols-2">
                ...
                <div class="p-8 bg-white border border-slate-200 rounded-[2rem] shadow-2xl shadow-slate-200/50">
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <button type="button" id="add-value-btn" class="px-5 py-2 text-[10px] font-black uppercase tracking-widest text-emerald-600 bg-emerald-50 border border-emerald-100 rounded-xl hover:bg-emerald-100 hover:cursor-pointer transition-all duration-300">
                            + Add Option
                        </button>
                    </div>
                    ...
                    <div id="values-container" class="space-y-4">
                        ...
                        @foreach($values as $value)
                            <div class="flex items-center gap-3 value-row group">
                                ...
                                <button type="button" class="p-3 text-red-500 bg-red-50 rounded-2xl hover:bg-red-100 hover:cursor-pointer transition-all duration-300 remove-value-btn opacity-40 group-hover:opacity-100">
            ...
            <div class="flex justify-end mt-12 gap-x-4">
                ...
                <button type="submit"
                        class="px-10 py-5 text-sm font-black uppercase tracking-widest  hover:cursor-pointer text-white bg-emerald-500 rounded-3xl shadow-2xl shadow-emerald-500/30 hover:bg-emerald-600 transition-all duration-300 hover:scale-[1.02] active:scale-[0.98]">
